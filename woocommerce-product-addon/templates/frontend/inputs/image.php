		            ...
		            <label>
		            	<div class="pre_upload_image <?php echo esc_attr($fm->input_classes()) ?>" >
							...
							if ( $image['image_id'] != '' ) {
								...
								?>
									<img data-image-tooltip="<?php echo wp_get_attachment_url($image['image_id']); ?>" src="<?php echo esc_url($image_url); ?>" class="img-thumbnail ppom-zoom-<?php echo esc_attr($fm->data_name()); ?>" title="<?php echo esc_attr($image_label); ?>" data-ppom-tooltip="ppom_tooltip">
